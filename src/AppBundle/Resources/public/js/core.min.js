 ...
 * @author       Manuel Masia - www.pixedelic.com
 * @license      MIT license
 * @version      v1.3.3
 */
...
/**
 * @module       TMGallaryPrototype
 */
!function(t){t.fn.TMgalleryPrototype=function(i){function o(){t("> ul",y).css({display:"none"}),n.destination.append("<div id='rootGalleryHolder'></div>"),d=t("#rootGalleryHolder"),d.append("<div id='previewHolder'><span class='previewLoader'></span><div id='previewCounterText'></div><div id='controlHolder'><div id='controlPrevBtn' class=''></div><div id='controlNextBtn' class=''></div></div><img src='' alt=''></div>"),s=t("#rootGalleryHolder #previewHolder"),v=t("#rootGalleryHolder #previewHolder #controlHolder"),g=t("#rootGalleryHolder #previewHolder #controlPrevBtn"),m=t("#rootGalleryHolder #previewHolder #controlNextBtn"),s.css({display:"none",position:"absolute",width:"100%",height:"100%","z-index":3}),t(">img",s).css({position:"relative"}),d.append("<div id='closeBtnPrototype'></div>"),_=t("body").css("min-width"),e()}function e(){function i(i,o){t("#previewCounterText",s).text(i+1+"/"+l),t(">img",s).fadeTo(o,0,function(){t(">img",s).attr("src","").attr("src",H[i]),G=!1,t(">img",s).bind("load",function(){t(this).unbind("load"),t(this).fadeTo(o,1),G=!0,v()})})}function o(t){x=!0,s.fadeTo(300,1),k=t,i(t,0)}function e(t){a=t.offset().left,h=t.width(),r=B.width(),c=P.width(),u=r-c,ratio=u/Math.round(c-h),f=Math.round(a*ratio),B.css({left:-f})}function n(){h=t(">._shuttle",P).width(),r=B.width(),c=P.width(),u=r-c,ratio=u/Math.round(c-h),a=-1*Math.round(B.offset().left/ratio),t(">._shuttle",P).css({left:a})}function v(){var i,o,e,n,d,l,r,a;G&&(i=t(">img",s).width(),o=t(">img",s).height(),d=o/i,l=t(window).height()/t(window).width(),l>d?(r="auto",a=t(window).height()):(r=t(window).width(),a="auto"),t(">img",s).css({width:r,height:a}),e=0,n=0,t(">img",s).css({left:e,top:n}))}function L(){halfWh=Math.round(t(window).height()-t("#rootGalleryHolder .thumbList").height())/2,t("#rootGalleryHolder .thumbList").css({"margin-top":halfWh}),t("#rootGalleryHolder .thumbList").width()>t(window).width()?P.css({display:"block"}):P.css({display:"none"})}var B,P,C,z=!1;y.click(function(){t("body").css({"min-width":"inherit",overflow:"hidden"}),d.css({display:"block"}),d.fadeTo(500,1),d.append("<ul class='thumbList'></ul>"),B=t(".thumbList",d),d.append("<div class='_track'><div class='_shuttle'></div></div>"),P=t("._track",d),P.css({display:"none"}),T=!1,l=t("> ul > li",this).length,k=0,b=[],H=[],C=setInterval(function(){L()},10),t("> ul > li",this).each(function(){b.push(t(this).attr("data-srcThumb")),H.push(t(this).attr("data-srcPreview")),B.append("<li><img src="+t(this).attr("data-srcThumb")+" alt=''><span></span></li>");var i=t("> li:last",B).find("img");i.fadeTo(0,0),M=0,i.bind("load",function(){t(this).unbind("load"),t(this).fadeTo(500,1),P.css({display:"block"}),clearInterval(C),L(),M+=t(this).width(),B.css({width:M})})}),T=!0,B.mousewheel(function(t,i,o,e){}),t(">._shuttle",P).draggable({axis:"x",containment:"parent",drag:function(i,o){e(t(this))}}),B.draggable({axis:"x",drag:function(t,i){return n(),w=Math.abs(B.offset().left)+d.width(),B.offset().left>0?(B.stop().animate({left:0},{duration:300,step:function(){n()}}),!1):w>B.width()?(B.stop().animate({left:-1*(B.width()-d.width())},{duration:300,step:function(){n()}}),!1):void 0},start:function(t,i){z=!0,B.addClass("grabbing")},stop:function(t,i){B.removeClass("grabbing")}}),t(">li",B).click(function(){z||o(t(this).index()),z=!1})}),g.click(function(){G&&(k--,0>k&&(k=l-1),i(k,400))}),m.click(function(){G&&(k++,k>l-1&&(k=0),i(k,400))}),t("#rootGalleryHolder #closeBtnPrototype").click(function(){x?(s.fadeTo(300,0,function(){t(this).css({display:"none"})}),x=!1,G=!1):(t("body").css({"min-width":_,overflow:"auto"}),d.fadeTo(500,0,function(){t(this).css({display:"none"}),t("#rootGalleryHolder .thumbList").remove(),t("#rootGalleryHolder ._track").remove()}))}),t(window).resize(function(){T&&(w=Math.abs(B.offset().left)+d.width(),w>=B.width()&&(p=B.width()-d.width(),B.css({left:-p})),h=t(">._shuttle",P).width(),r=B.width(),c=P.width(),u=r-c,ratio=u/Math.round(c-h),a=-1*Math.round(B.offset().left/ratio),t(">._shuttle",P).css({left:a}),L()),v()}).trigger("resize")}var n={destination:t("#baseHolder")};t.extend(n,i);var d,s,l,r,a,h,c,u,f,w,p,v,g,m,y=t(this),b=[],H=[],T=!1,x=!1,G=!1,k=0,M=0,_=0;o()}}(jQuery);